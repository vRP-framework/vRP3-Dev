local config = module('cfg/player')
...
Solar:RegisterCallback('loadCharacters', function(characters)
	SendNUIMessage({
...
RegisterNUICallback('saveCharacter', function(data, cb)
	Solar:TriggerCallback('saveCharacter', function(isCreated)
		if isCreated then
			cb({ success = true })
		else
			cb({success= false})
...
RegisterNUICallback('selectCharacter', function(data, cb)
	isCreatingCharacter = false
	Solar:TriggerCallback('selectCharacter', function(isSelected)
		if isSelected then
			DestroyCam(cam, false)
