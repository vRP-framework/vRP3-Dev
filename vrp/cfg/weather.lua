...
cfg.api = {
    ...
    key = "82d53c607c554a1da8f195635251702",      -- Replace with your WeatherAPI key
    default_city = "Bucharest",                   -- Your chosen city
    update_interval = 1000 * 60 ,                     -- Update every 15 minutes (in milliseconds)
