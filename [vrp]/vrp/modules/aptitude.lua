    ...
    for k,v in pairs(aptitudes) do -- each group
        ...
        for l,w in pairs(v) do -- each aptitude
          ...
          if def then
            ...
            parts[#parts+1] = "<div style=\"width: 500px; height: 25px; margin-bottom: 3px;\" class=\"dprogressbar\" data-value=\""
              ..(percent/100).."\" data-color=\"rgba(0,125,255,0.7)\" data-bgcolor=\"rgba(0,125,255,0.3)\">"
              ..lang.aptitude.display.aptitude({def[1], exp, lvl, percent}).."</div>"
          end
        end
